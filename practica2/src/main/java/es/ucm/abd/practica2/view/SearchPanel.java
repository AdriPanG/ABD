...
public class SearchPanel extends javax.swing.JPanel {
        ...
        tableAbedemons.getSelectionModel().addListSelectionListener(
            ...
            public void valueChanged(ListSelectionEvent e) {
                if(tableAbedemons.getSelectedRow() != -1) {
                    String info = null;
					try {
						info = controller.getAbedemonInfo(tableAbedemons.getSelectedRow());
    ...
    private void comboTiposActionPerformed(java.awt.event.ActionEvent evt) throws XQException, IOException {//GEN-FIRST:event_comboTiposActionPerformed
        controller.searchAbedemonsOf(comboTipos.getSelectedIndex());
    }//GEN-LAST:event_comboTiposActionPerformed

    private void textPaneAbedemonsHyperlinkUpdate(javax.swing.event.HyperlinkEvent evt) throws XQException, IOException {//GEN-FIRST:event_textPaneAbedemonsHyperlinkUpdate
