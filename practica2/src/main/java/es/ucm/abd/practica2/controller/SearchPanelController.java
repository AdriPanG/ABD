...
public class SearchPanelController {
    ...
    public void searchAbedemonsOf(int typeIndex) throws XQException, IOException {
        if (typeIndex != 0) {
    ...
    public String getAbedemonInfo(int rowIndex) throws XQException, IOException {
        if (rowIndex != -1) {
    ...
    public String getAbedemonInfo(String id) throws XQException, IOException {
